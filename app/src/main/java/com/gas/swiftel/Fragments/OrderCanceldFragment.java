 ...
 */
public class OrderCanceldFragment extends Fragment {
    View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_order_canceld, container, false);
        mAuth =FirebaseAuth.getInstance();
        mRecyclerView = root.findViewById(R.id.RecyclerviewCanceled);
        swipeRefreshLayout = root.findViewById(R.id.SwipeCancel);
