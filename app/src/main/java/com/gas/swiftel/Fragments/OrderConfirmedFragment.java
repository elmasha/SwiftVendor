...
View root;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_order_confirmed, container, false);
        mAuth =FirebaseAuth.getInstance();
        mRecyclerView = root.findViewById(R.id.Recyclerview_Confirmed);
        swipeRefreshLayout = root.findViewById(R.id.SwipeConfirm);
